...
const BattleBots = () => (
  <Container>
    <Row>
      <Col>
      This project report was done in my advance data analytics class. I was required to conduct ANOVA on a set of rat feed data and discuss any relevant findings. 
